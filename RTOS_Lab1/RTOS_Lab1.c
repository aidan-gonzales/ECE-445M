...
/*
  //this is for testing the message function in the prelab
  ST7735_Message(0, 0, "The value is: ", 42);
  ST7735_Message(0, 1, "The value is: ", 42);

  ST7735_Message(0, 7, "The value is: ", 42);
  ST7735_Message(1, 0, "The value is: ", 42);
  ST7735_Message(1, 7, "The value is: ", 42);
  */
