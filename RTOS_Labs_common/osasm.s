...
// with the .space assembly directive
     ...
     .global  StartOS
//;     .global  ContextSwitch2 // commented out for now. It's causing a linker problem
...
StartOS:
// put your code here
        LDR R0, =RunPt         // R0 is pointer to RunPt
        LDR R1, [R0]           // R1 = RunPt
...
// put your code here
    ...
    PUSH {R4-R7}               // saves remaining registers
    LDR R0, =RunPt             // R0 = pointer to RunPt, old thread
    LDR R1, [R0]               // R1 = RunPt
    MOV R2, SP                 // extra instruction required for Cortex M0
    STR R2, [R1]               // save SP into TCB

    LDR R2, =NextThreadPt
    LDR R2, [R2]
    STR R2, [R0]               // RunPt = R1 // RunPt = NextThreadPt

    LDR R0, [R2]               // new thread SP: SP = RunPt->SP
    MOV SP, R0                 // extra instruction required for Cortex M0
    POP {R4-R7}                // restore new thread's saved registers


    CPSIE I                    // reenables interrupts    
